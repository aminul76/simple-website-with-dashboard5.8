...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
        ...
        <!--== 6. About us ==-->
      <section id="pricing" class="menu-list">
    <div id="w">
                            ...
                            <div class="section-header">
                                ...
                                <ul id="filter-list" class="clearfix">
                                    ...
                                    @foreach($categories as $category)
                                        ...
                                        <!--data-filter="#{{ $category->id }}" it send the id  {{ $category->name }}  get name from the database -->
                                    @endforeach
                                </ul><!-- @end #filter-list -->
                            </div>
                        </div>
                                ...
                                <form class="reservation-form" method="post" action="{{route('reservation.reserve')}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <!-- form_datetime use script code blew th script . -->
                                                <input type="text" class=" form_datetime form-control reserve-form empty iconified" name="dateandtime" id="datepicker" required="required" placeholder="&#xf017;  Time">
                                            </div>
                                        </div>
        ...
        <script type="text/javascript">
            //.form_datetime it is used input class
